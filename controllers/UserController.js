...
class UserController {
    static async register(req, res, next) {
        try {
            ...
            // let imgProfilePath;
            // if(req.file.path) {
            //     imgProfilePath = req.file.path
            // } else {
            //     imgProfilePath = 'https://t4.ftcdn.net/jpg/03/46/93/61/360_F_346936114_RaxE6OQogebgAWTalE1myseY1Hbb5qPM.jpg'
            // }
            ...
            const newUser = await User.create({
                ...
                email,
                password,
                imgProfile: imgProfilePath.path
            })
